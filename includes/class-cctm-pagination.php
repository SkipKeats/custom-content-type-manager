<?php
/**
 * CCTM Pagination file
 *
 * PHP 7.2+
 *
 * @category Component
 * @package CCTM
 * @subpackage CCTM_Pagination
 * @author Everett Griffiths and others (everett@fireproofsocks (2010, revised 2012))
...
class CCTM_Pagination {
	 ...
	 * Template snippet.
	 *
	 * @var string $first_tpl Snippet.
	 */
	private $first_tpl = '<a href="[+base_url+]&offset=[+offset+]" [+extra+]>&laquo; First</a> &nbsp;';
	 ...
	 * Template snippet
	 *
	 * @var string $last_tpl Snippet.
	 */
	private $last_tpl = '&nbsp;<a href="[+base_url+]&offset=[+offset+]" [+extra+]>Last &raquo;</a>';
	 ...
	 * Template snippet
	 *
	 * @var string $prev_tpl Snippet.
	 */
	private $prev_tpl = '<a href="[+base_url+]&offset=[+offset+]" [+extra+]>&lsaquo; Prev.</a>&nbsp;';
	 ...
	 * Template snippet.
	 *
	 * @var string $next_tpl Snippet.
	 */
	private $next_tpl = '&nbsp;<a href="[+base_url+]&offset=[+offset+]" [+extra+]>Next &rsaquo;</a>';
	 ...
	 * Template snippet.
	 *
	 * @var string $current_page_tpl Snippet.
	 */
	private $current_page_tpl = '&nbsp;<span>[+page_number+]</span>&nbsp;';
	 ...
	 * Template snippet.
	 *
	 * @var string $page_tpl Snippet.
	 */
	private $page_tpl = '&nbsp;<a href="[+base_url+]&offset=[+offset+]" [+extra+]>[+page_number+]</a>&nbsp;';
	 ...
	 * Template snippet
	 *
	 * @var string $outer_tpl Snippet.
	 */
	private $outer_tpl = '<div id="pagination">[+content+]<br/>
	 ...
	 *
	 * @var integer $link_cnt A link count.
	 */
	private $link_cnt = 10;
	 ...
	 *
	 * @var integer $jump_size How big to jump.
	 */
	private $jump_size = 1;
	 ...
	 *
	 * @var integer $default_results_per_page Number of links per page.
	 */
	 ...
	 *
	 * @var array $properties Properties array.
	 */
	 ...
	 *
	 * Parses the first template (first_tpl).
	 *
	 * @return string
	 */
	private function _parse_first_tpl() {
		if ( $this->offset > 0 ) {
			return $this->_parse(
				$this->first_tpl,
				array(
	 ...
	 * @return string
	 */
	private function _parse_last_tpl() {
	 ...
	 * @return string
	 */
	private function _parse_next_tpl() {
	 ...
	 * @return string
	 */
	private function _parse_prev_tpl() {
	 ...
	 *
	 * @param integer $current_pg Current page.
	 * @param integer $total_pgs_shown Total number of shown pages.
	 * @param integer $total_pgs Total pages.
	 * @return integer
	 */
	 ...
	 * @param integer $results_per_page Number of results per page.
	 * @return integer
	 */
	...
	public function paginate( $record_count ) {
		...
		if ( ( $record_count <= $this->results_per_page ) && 0 === $this->offset ) {
			return ' ';
		}
		...
		$this->properties['content']  = $this->_parse_first_tpl();
		$this->properties['content'] .= $this->_parse_prev_tpl();
		$this->properties['content'] .= $this->_parse_pagination_links();
		$this->properties['content'] .= $this->_parse_next_tpl();
		$this->properties['content'] .= $this->_parse_last_tpl();
		$first_pass                   = $this->_parse( $this->outer_tpl, $this->properties );
	 ...
	 *
	 * @param string $tpl One of the named templates.
	 ...
	 * Set Templates
	 *
	 * Set all the templates in one go by supplying an array.  You must supply
