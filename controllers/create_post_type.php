...
$data['icons'] = CCTM_Post_Type_Def::get_post_type_icons();
$data['columns'] = CCTM_Post_Type_Def::get_columns($post_type);
$data['orderby_options'] = CCTM_Post_Type_Def::get_orderby_options($post_type);
